...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - SAND Raiders of Sophie Wiki',
    description: 'Copyright and intellectual property information for SAND Raiders of Sophie Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - SAND Raiders of Sophie Wiki',
      description: 'Copyright and intellectual property information for SAND Raiders of Sophie Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 SAND Raiders of Sophie Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of SAND Raiders of Sophie Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              SAND Raiders of Sophie Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Developers of SAND: Raiders of Sophie</strong> - Creators of the SAND: Raiders of Sophie game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>SAND: Raiders of Sophie</strong> - Trademark of the game developers</li>
              <li><strong>SAND Raiders of Sophie Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with SAND Raiders of Sophie Wiki.
            </p>
            ...
            <p>
              ...
              SAND Raiders of Sophie Wiki<br />
              Email: <a href="mailto:dmca@sand-raiders-of-sophie.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@sand-raiders-of-sophie.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "SAND Raiders of Sophie Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: SAND Raiders of Sophie Wiki (sand-raiders-of-sophie.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@sand-raiders-of-sophie.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@sand-raiders-of-sophie.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@sand-raiders-of-sophie.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@sand-raiders-of-sophie.wiki</a>
            </p>
            <p>
